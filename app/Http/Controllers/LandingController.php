...
class LandingController extends Controller
{
    public function index()
    {
        ...
        $pengumuman = PengumumanModel::latest('tanggal_pengumuman')->limit(3)->get();
        $usaha = UsahaSiswaModel::latest()->limit(3)->get();
        $socialMedia = [
            [
        ...
        return view('users.index', compact('perusahaan', 'pengumuman', 'usaha', 'socialMedia', 'faqItems'));
    }
}
