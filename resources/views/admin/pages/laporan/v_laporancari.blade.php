        ...
        <form action="/admin/laporan/cari" method="GET">
            <table width=100%>
                <tr>
                    <td width=25%>
                        Tanggal Awal
                        <input type="date" class="form-control col-sm-10" name="tglawal" id="tglawal" value="{{$tglawal}}" required>
                    </td>
                    
                    <td width=25%>
                        Tanggal Akhir
                        <input type="date" class="form-control col-sm-10" name="tglakhir" id="tglakhir" value="{{$tglakhir}}" required>
                    </td>
